...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"db-timetables-pp-cli auth login",
		"db-timetables-pp-cli doctor",
		"db-timetables-pp-cli help items",
		"db-timetables-pp-cli sync",
		"db-timetables-pp-cli profile list",
		"db-timetables-pp-cli feedback list",
		"db-timetables-pp-cli which",
		"db-timetables-pp-cli agent-context",
		"db-timetables-pp-cli completion bash",
		"db-timetables-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"db-timetables-pp-cli recall",
		"db-timetables-pp-cli learnings",
		"db-timetables-pp-cli teach-pattern",
		"db-timetables-pp-cli teach-lookup",
		"db-timetables-pp-cli items list",
	}
