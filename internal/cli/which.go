...
var whichIndex = []whichEntry{
	{Command: "board", Description: "See the live board for one station this hour: planned trains with delays, platform moves, and cancels overlaid.", Group: "Live station board", WhyItMatters: "Reach for this instead of calling plan and fchg separately when a traveler or agent wants the truth at a station."},
	{Command: "platforms", Description: "List only the trains at a station whose platform changed.", Group: "Live station board", WhyItMatters: "Use this when the question is which platforms moved, not the full board."},
	{Command: "cancellations", Description: "List cancellations at a station for the current hour.", Group: "Live station board", WhyItMatters: "Use this when the question is what was cancelled, not every delay."},
	{Command: "delays", Description: "List late trains at a station with delay minutes.", Group: "Live station board", WhyItMatters: "Use this for late-but-running trains; cancellations are a different command."},
	{Command: "watch", Description: "Apply the last two minutes of rchg onto a cached plan+fchg snapshot.", Group: "Local state that compounds", WhyItMatters: "Use this to poll cheaply after board/fchg; do not use it as the first fetch."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  db-timetables-pp-cli which "stale tickets"
  db-timetables-pp-cli which "bottleneck"
  db-timetables-pp-cli which --limit 1 "send message"
  db-timetables-pp-cli which                                # list the full capability index`,
