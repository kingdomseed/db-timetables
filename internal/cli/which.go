...
var whichIndex = []whichEntry{
	{Command: "insight", Description: "Computed guidance that turns a station pattern or EVA number into plan/fchg/rchg commands.", Group: "", WhyItMatters: ""},
	{Command: "health", Description: "GROUP BY counts and percentages over locally synced timetable resources.", Group: "", WhyItMatters: ""},
	{Command: "coverage", Description: "Coverage of expected station/fchg/rchg/plan slices in the local store.", Group: "", WhyItMatters: ""},
	{Command: "stale", Description: "Freshness insight for synced timetable slices versus a stale-after budget.", Group: "", WhyItMatters: ""},
}
