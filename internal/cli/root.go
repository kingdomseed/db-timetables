...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: "Manage db-timetables resources via the db-timetables API",
		Long: `Manage db-timetables resources via the db-timetables API.
...
Run 'db-timetables-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		...
		if !shouldSkipLearnHook(cmd.CommandPath()) {
	...
	rootCmd.AddCommand(newInsightCmd(flags))
