...
func Load(configPath string) (*Config, error) {
	...
	if _, v := firstSetEnv("DB_TIMETABLES_API_KEY", "DB_API_KEY", "TIMETABLES_CLIENT_SECRET"); v != "" {
		cfg.ClientSecret = v
...
func (c *Config) CredentialConfigured() bool {
	...
	return c.AuthHeader() != "" && strings.TrimSpace(c.ClientSecret) != ""
}
...
// SaveApiKey persists the Marketplace client secret sent as DB-Api-Key.
