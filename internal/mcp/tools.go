		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 400") && cliutil.LooksLikeAuthError(msg):
				return mcpToolError("authentication error: " + cliutil.SanitizeErrorBody(msg) +
					...
					"\n      Set your API key with: export DB_TIMETABLES_CLIENT_ID=\"your-client-id\" and DB_TIMETABLES_API_KEY=\"your-api-key\"" +
			...
			"env_vars": []map[string]any{
				{
					...
					"required":    true,
					"sensitive":   true,
					"description": "Marketplace client id sent as DB-Client-Id. Also accepts DB_CLIENT_ID.",
				},
				{
					...
					"required":    true,
					"sensitive":   true,
					"description": "Marketplace client secret sent as DB-Api-Key. Also accepts DB_API_KEY or TIMETABLES_CLIENT_SECRET.",
				},
			},
		},
