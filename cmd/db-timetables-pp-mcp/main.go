...
import (
	...
	mcptools "db-timetables-pp-cli/internal/mcp"
...
func main() {
	...
	_ = os.Setenv("DB_TIMETABLES_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "db-timetables-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
